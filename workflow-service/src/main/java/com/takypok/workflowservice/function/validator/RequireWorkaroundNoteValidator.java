...
@Slf4j
public class RequireWorkaroundNoteValidator implements ValidatorInterface {
  ...
  public Mono<Boolean> validate(
    ...
    return Mono.just(request.getWorkaroundNote() != null && !request.getWorkaroundNote().isBlank());
  }

  @Override
  public String validateFailedMessage() {
    return "A workaround note is required before marking this problem as a Known Error.";
  }
}
