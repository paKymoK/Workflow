  ...
  return (
    <Modal title="Register User" open={open} onCancel={handleClose} footer={null} width={480}>
      <Form form={form} layout="vertical" onFinish={handleSubmit} className="mt-4">
        ...
        <Form.Item label="Full Name" name="name" rules={[{ required: true, message: "Please enter the full name" }]}>
        ...
        <Form.Item label="Department" name="department" rules={[{ required: true, message: "Please enter a department" }]}>
